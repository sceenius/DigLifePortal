  ...
  <div class="md-layout md-gutter" style="padding: 20px;">
    ...
    >
      ...
      <div class="md-card-header">
        ...
        <p class="info" style="width: 250px; height: 90px; overflow: auto;"></p>
      </div>

      <div class="md-card-mid">
        <md-chip v-for="tag in note.tags" :key="tag.id"> {{ tag }} </md-chip>
      </div>
...
.md-card-banner {
  ...
  color: white;
  height: 50px;
  background-color: #00b0a0; /* DigLife:00B0A0 Xmas:00B0A0*/
  overflow: hide;
}

.md-card-banner .md-button {
...
.md-card-banner .md-button .md-icon {
...
#noteCards.md-card .md-title {
  font-size: 1.4em !important;
  line-height: 1.2em;
  font-weight: normal !important;
}

#noteCards.md-card .md-chip {
  margin: 3px;
  position: relative;
  top: 0;
  right: 0;
